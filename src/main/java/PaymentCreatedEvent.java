...
public class PaymentCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6608392195294105746L;
   ...
   */
  public static PaymentCreatedEvent.Builder newBuilder() {
    return new PaymentCreatedEvent.Builder();
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static PaymentCreatedEvent.Builder newBuilder(PaymentCreatedEvent.Builder other) {
    return new PaymentCreatedEvent.Builder(other);
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static PaymentCreatedEvent.Builder newBuilder(PaymentCreatedEvent other) {
    return new PaymentCreatedEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(PaymentCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(PaymentCreatedEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public PaymentCreatedEvent.Builder setCheckoutCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PaymentCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PaymentCreatedEvent.Builder setCheckoutStatus(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PaymentCreatedEvent.Builder clearCheckoutStatus() {
      checkoutStatus = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PaymentCreatedEvent.Builder setPaymentCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PaymentCreatedEvent.Builder clearPaymentCode() {
      paymentCode = null;
